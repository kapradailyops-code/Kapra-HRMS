...
export default function LeaveApprovalsPage() {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8">
            <div>
                <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Leave Approvals</h1>
                <p className="mt-1 text-sm text-gray-500">Review and manage pending time off requests from your team.</p>
            </div>
                            ...
                            <li key={req.id} className="p-6 hover:bg-gray-50 transition-colors flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
                                ...
                                <div className="flex shrink-0 gap-3 w-full sm:w-auto mt-4 sm:mt-0 pt-4 sm:pt-0 border-t sm:border-t-0 border-gray-100">
                                    <button
                                        ...
                                        className="flex-1 sm:flex-none px-4 py-2 border border-red-200 text-red-700 bg-red-50 hover:bg-red-100 rounded-lg text-sm font-semibold transition-colors disabled:opacity-50"
                                    >
                                        Reject
                                    </button>
                                    <button
                                        ...
                                        disabled={processingId === req.id}
                                        className="flex-1 sm:flex-none px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-semibold shadow-sm transition-colors disabled:opacity-50"
                                    >
